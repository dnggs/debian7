...
state=Tangerang
locality=Batu ceper
organization=DNGGSSH
organizationalunit=VPS
commonname=dnggssh.cf
email=dnggs09@gmail.com
...
echo 'echo -e "Patuhi Terms Of Service "' >> .bashrc
...
# download script
cd /usr/bin
wget -O menu "https://raw.githubusercontent.com/dnggs/debian7/master/menu.sh"
wget -O usernew "https://raw.githubusercontent.com/dnggs/debian7/master/usernew.sh"
wget -O trial "https://raw.githubusercontent.com/dnggs/debian7/master/trial.sh"
